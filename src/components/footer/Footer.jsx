...
function Footer() {
  return (
    <div className='container-footer bg-gray-300 sticky bottom-0 p-4'>
        <div className='head-footer flex justify-evenly'>
            <img src={logoFooter} alt='' className='img-logo-footer w-24'></img>
            <div className='adress-container mt-3 flex flex-col items-center'>
                <p>C/ Asturias 18, 33004 Oviedo // +34 984 068 532</p>
                <p>info@idealelaura&marta.es</p>
                <p>www.ideale.es</p>
            </div>
            <div className='icons-container mt-5 gap-4 mb-2'>
